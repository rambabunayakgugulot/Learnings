...
Before (no handling):
C#// Code Generated by Sidekick is for learning and experimentation purposes only.
...
Validation:C#// Code Generated by Sidekick is for learning and experimentation purposes only.
if (amount <= 0)
    return BadRequest("Amount must be positive.");


Exception Handling:C#// Code Generated by Sidekick is for learning and experimentation purposes only.
try
{
